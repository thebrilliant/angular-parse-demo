...
angular.module('ToDoApp', [])
    .config(function($httpProvider) {
        ...
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = 'ER0iHIWwbje5aWuW0O2XDDftT7u9kwFVaiw0VUL0';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = '2EstSIrIRj51g9BSwpfEpzQeWFPZaBNWCrbCyaXe';
    })
    ...
    .controller('TasksController', function($scope, $http) {
        ...
        //call the refreshTasks() to get the initial set of tasks on the page load
        $scope.refreshTasks();
        ...
        $scope.addTask = function(task) {
            ...
            $http.post('https://api.parse.com/1/classes/tasks', task)
                .success(function(responseData) {
                    ...
                    //reset the newTasko clear the form
                    $scope.newTask = {done: false};
                });
        };
        ...
        $scope.updateTask = function(task) {
            $scope.updating = true;
            $http.put('https://api.parse.com/1/classes/task'+ task.objectId, task)
                .success(function(responseData) {
